 ...
 * @since 1.0.0
 */
class trending_posts extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Trending Posts', 'trending_posts' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Content', 'trending_posts' ),
	...
	?>
		<div class= "trending-post-section">
			...
			<div class="trending-post-listing">
				<?php
					$count = 1;
					foreach ($allposts as $post_id) {
						...
						<div class="content-box">
							...
							<div class="content-data d-flex">
								<span><?php print $count; ?></span><h5 class="featured-content-heading"><a href="<?php print $slug; ?>"><?php print $title; ?></a></h5>
							</div>
						</div>
						<?php
						$count++;
