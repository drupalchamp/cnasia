 ...
 * @since 1.0.0
 */
class latest_posts extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest Posts', 'latest_posts' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Content', 'latest_posts' ),
	...
	protected function render() {
		...
		?>
		<div class= "latest-post-first-section">
